...
import com.razrabotkin.tests.presenter.search.PresenterSearchContract
import com.razrabotkin.tests.presenter.search.SearchPresenter
import com.razrabotkin.tests.repository.FakeGitHubRepository
import com.razrabotkin.tests.repository.GitHubApi
...
class MainActivity : AppCompatActivity(), ViewSearchContract {
        ...
        searchEditText.setOnEditorActionListener(OnEditorActionListener { _, actionId, _ ->
            if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                ...
                if (query.isNotBlank()) {
                    ...
                    Toast.makeText(
                        this@MainActivity,
                        getString(string.enter_search_word),
                        Toast.LENGTH_SHORT
                    ).show()
    ...
    override fun displayError() {
        Toast.makeText(this, getString(string.undefined_error), Toast.LENGTH_SHORT).show()
    }
