...
import com.razrabotkin.tests.stubs.ScheduleProviderStub
import com.razrabotkin.tests.view.search.ScreenState
import com.razrabotkin.tests.view.search.SearchViewModel
...
class SearchViewModelTest {
    ...
    fun coroutines_TestReturnValueIsNotNull() {
        testCoroutineRule.runBlockingTest {
            ...
            org.mockito.Mockito.`when`(repository.searchGithubAsync(SEARCH_QUERY))
                .thenReturn(
